...
class Piano_Key:
  def __init__(self,key,file_name,Channel_ID):
    ...
    # each key has a different channel ID associated with it
    self.Channel_ID = Channel_ID
    # function that triggers a piano key, each key triggers a file name and channel
  def play(self):
    ...
    # function to stop the key sound
  def stop(self):
    # fades the key sound
    pygame.mixer.Channel(self.Channel_ID).fadeout(300)
    # iterates through the list and finds the key that is pressed
